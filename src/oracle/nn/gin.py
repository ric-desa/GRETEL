...
from src.utils.torch.gin import GIN


class DownstreamGIN(GIN):
    ...
    def __init__(self, node_features,
                 ...
                 edge_dim=1,
                 use_weights=True,
                 class_="MultiHeadGGINConv"):
        
        super().__init__(node_features, num_conv_layers, conv_booster, pooling, use_weights, class_)
